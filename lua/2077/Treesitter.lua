local Treesitter = {
	...
	TSVariable = { fg = C.purple_test_2 },
	TSVariableBuiltin = { fg = C.vivid_sky_blue },
	TSProperty = { fg = C.purple_test_2 },
	TSOperator = { fg = C.gray_new },
	TSField = { fg = C.purple_test_2 },
	TSParameter = { fg = C.purple_test_2 },
	TSParameterReference = { fg = C.purple_test_2 },
	TSSymbol = { fg = C.purple_test_2 },
	TSText = { fg = C.gray_new },
	TSPunctDelimiter = { fg = C.gray_new },
	TSTagDelimiter = { fg = C.gray },
	TSTagAttribute = { fg = C.purple_test_2 },
	...
	TSStructure = { fg = C.purple_test_2 },
	TSStrong = { fg = C.cy, style = "bold" },
	TSQueryLinterError = { fg = C.aureolin },
